var templateManager = (function () {
    ...
    defaultWordList = [
        { text: 'Happy', fontSize: 36 },
        { text: 'Much', fontSize: 36 },
        { text: 'Quickly', fontSize: 36 },
        { text: 'Tired', fontSize: 36 },
        { text: 'Work', fontSize: 36 },
        { text: 'Show', fontSize: 36 },
        { text: 'Really', fontSize: 36 },
        { text: 'Snow', fontSize: 36 },
        { text: 'Calm', fontSize: 36 },
        { text: 'Bird', fontSize: 36 },
        { text: 'Walk', fontSize: 36 },
        { text: 'Small', fontSize: 36 },
        { text: 'Dry', fontSize: 36 },
        { text: 'Make', fontSize: 36 },
        { text: 'List', fontSize: 36 },
        { text: 'Jump', fontSize: 36 }
    ];
